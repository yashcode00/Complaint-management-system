<?php
   ...
   $db = mysqli_connect('localhost', 'root', '', 'complaint_database') or die('Could not connect to database!');
   ...
   if(isset($_POST['reg_user'])){
    ...
    $gender==$_POST['gender'];
   	...
   	$password_2 = mysqli_real_escape_string($db, $_POST['password2']);
   	 ...
   	 $user_check = "SELECT * FROM registrations WHERE username ='$username' OR email ='$email' LIMIT 1";
