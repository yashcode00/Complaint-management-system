...
<body>
    <div class="main-container container-fluid">
        <div class="row main-row">
            <div class="col-12 col-md-6 left-div container-fluid">
               ...
               <a href="#"><h5 id="forgotpass">Forgot your password?</h5></a>
                    <button type="submit" class="btn btn-primary">Submit</button>
                </form>
                <!-- <form  method="post" id="signup" class="hidden">
            ...
            <div class="col-12 col-md-6 right-div">
                <div class="register">
                    <h1>Hello!</h1>
                    <h4>Enter your details and Register with us.</h4>
                    <a href="register.php">
                    <button class="sign-btn btn">Sign Up!</button></a>
                </div>
                <!-- <div class="login hidden">
                    <h1>Hello!</h1>
                    <h4>Already registered?</h4>
                    <button class="sign-btn btn">Sign In!</button>
                </div>  -->
